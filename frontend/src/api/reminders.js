...
export const getFailedReminders = (token) => API.get('/failed', { headers: { Authorization: `Bearer ${token}` } });
export const resendReminder = (id, token) => API.post(`/${id}/resend`, {}, { headers: { Authorization: `Bearer ${token}` } });
